  ...
  computed: {
    ...
    scoreMessage() {
      const cases = {
        ...
        1: 'Time to brush up on your game.',
        2: 'Were you just guessing?',
        3: "Google is your friend. Consider it today.",
        4: "Don't worry — a 4/10 is average.",
        5: 'So-so performance. Not bad. Not great. Maybe better luck next time.',
        6: 'You may one day be a wealth of trivial knowledge. But that day is not today.',
        7: 'Not bad. Can you perform this well a once again?',
        8: "You're on your way to becoming a  master.",
        9: 'A regular trivia wiz. Nice work.',
        10: 'Holy tomato!! A perfect score! Excellent work.',
      };
...
.modal {
  align-items: center;
  animation: fade-in .5s ease forwards; // defined in main.scss
